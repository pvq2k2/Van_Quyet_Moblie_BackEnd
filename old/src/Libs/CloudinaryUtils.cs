...
namespace Libs
{
    ...
    {
        public Task<string> UploadImage(IFormFile file, string folderPath, string fileName);
        public Task<bool> DeleteImageByUrl(string imageUrl);
    }
    public class CloudinaryUtils : ICloudinaryUtils
    {
        private readonly Cloudinary _cloudinary;

        public CloudinaryUtils(IConfiguration configuration)
        {
