...
public abstract class VQMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static VQMWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(VQMWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<VQMDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<VQMDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<VQMDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<VQMDbContext, Task<T>> func)
    {
        T result;
